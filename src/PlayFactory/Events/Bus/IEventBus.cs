...
namespace PlayFactory.Events.Bus
{
    ...
    public interface IEventBus : ISingleInstanceDependency
    {
        ...
        ///// <summary>
        ///// Efetua o pregistro dos Handlers.
        ///// Obs.: Os registros só serão concliídos ao executar o método  <see cref="THandler"/>
        ///// </summary>
        ///// <param name="eventType">Event Type</param>
        ///// <param name="handlerType">Handler Type</param>
        //void PreRegister(Type eventType, Type handlerType);

        ///// <summary>
        ///// Registra todos os Handlers que foram definidos como PreRegister.
        ///// </summary>
        ///// <returns>Retorna uma lista de Disposable referente a cada registro de Handler.</returns>
        //List<IDisposable> RegisterAllPreRegister(IocResolver resolver); 
