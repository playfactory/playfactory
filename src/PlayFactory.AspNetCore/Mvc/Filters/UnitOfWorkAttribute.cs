...
namespace PlayFactory.AspNetCore.Mvc.Filters
{
    ...
    {
        public UnitOfWorkAttribute() : base(typeof(UnitOfWorkFilterImpl))
        {
        }

        private class UnitOfWorkFilterImpl : IActionFilter
        {
            private readonly IUnitOfWork _unitOfWork;
            private readonly IPlayFactoryOptionsCore _options;
            private bool _allowUnitOfWork;

            public UnitOfWorkFilterImpl(IUnitOfWork unitOfWork, IPlayFactoryOptionsCore options)
            {
